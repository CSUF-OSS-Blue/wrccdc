...
if command_exists systemctl; then
    ...
    consolidated_output+="Could not detect service manager (systemd or service).\n"
fi
consolidated_output+="------------------------------------------\n"
...
if $ip_installed; then
    consolidated_output+="Connected interfaces (ip link):\n"
...
consolidated_output+="Unmounted filesystems (fstab):\n"

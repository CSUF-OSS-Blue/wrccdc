...
if command_exists rc-status; then
    consolidated_output+="\033[1;31mActive Services:\n\033[0m"
...
if $netstat_installed; then
    consolidated_output+="\033[1;31mListening ports (netstat):\n\033[0m"
    consolidated_output+="$(run_command 'netstat -tulnp')\n"
else
    consolidated_output+="\033[1;31mListening ports (ss):\n\033[0m"
...
consolidated_output+="\033[1;31mSystem wide cron jobs:\n\033[0m"
consolidated_output+="$(run_command 'cat /etc/crontab')\n"
consolidated_output+="------------------------------------------\n"

# Get anacron jobs
consolidated_output+="\033[1;31mAnacron jobs:\n\033[0m"
...
consolidated_output+="\033[1;31mActive interfaces:\n\033[0m"
